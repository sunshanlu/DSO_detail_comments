...
public:
    ...
    /**
     * @brief 计算了 host --> target 的 位姿 + 仿射参数 + 相机内参 的 海塞矩阵
     * @details
     * 	1. 计算了 drk / dTth 、drk / dC
     *	2. 针对 dpj / dTth 和 dpj / dC 根据FEJ进行计算（不过在DSO的源码里面C内参并没有固定线性化点）
     * @note 仿射参数ab和位姿Tth都是相对量，最后还需要根据 伴随矩阵的性质进行绝对量的转换
     * @param x4	输入的 dpjf[x] / dC
     * @param x6	输入的 dpjf[y] / dC
     * @param y4	输入的 dpjf[x] / dTth
     * @param y6	输入的 dpjf[y] / dTth
     * @param a		输入的 sum((drk / dpj[x])(drk / dpj[x]))
     * @param b		输入的 sum((drk / dpj[x])(drk / dpj[y]))
     * @param c		输入的 sum((drk / dpj[y])(drk / dpj[y]))
     */
    inline void update(const float *const x4, const float *const x6, const float *const y4, const float *const y6, const float a, const float b,
                       const float c) {
        Data[0] += a * x4[0] * x4[0] + c * y4[0] * y4[0] + b * (x4[0] * y4[0] + y4[0] * x4[0]); ///< (drk / dfx) * (drk / dfx)
        Data[1] += a * x4[1] * x4[0] + c * y4[1] * y4[0] + b * (x4[1] * y4[0] + y4[1] * x4[0]); ///< (drk / dfx) * (drk / dfy)
        Data[2] += a * x4[2] * x4[0] + c * y4[2] * y4[0] + b * (x4[2] * y4[0] + y4[2] * x4[0]); ///< (drk / dfx) * (drk / dcx)
        Data[3] += a * x4[3] * x4[0] + c * y4[3] * y4[0] + b * (x4[3] * y4[0] + y4[3] * x4[0]); ///< (drk / dfx) * (drk / dcy)
        Data[4] += a * x6[0] * x4[0] + c * y6[0] * y4[0] + b * (x6[0] * y4[0] + y6[0] * x4[0]); ///< (drk / dfx) * (drk / dtx)
        Data[5] += a * x6[1] * x4[0] + c * y6[1] * y4[0] + b * (x6[1] * y4[0] + y6[1] * x4[0]); ///< (drk / dfx) * (drk / dty)
        Data[6] += a * x6[2] * x4[0] + c * y6[2] * y4[0] + b * (x6[2] * y4[0] + y6[2] * x4[0]); ///< (drk / dfx) * (drk / dtz)
        Data[7] += a * x6[3] * x4[0] + c * y6[3] * y4[0] + b * (x6[3] * y4[0] + y6[3] * x4[0]); ///< (drk / dfx) * (drk / dRx)
        Data[8] += a * x6[4] * x4[0] + c * y6[4] * y4[0] + b * (x6[4] * y4[0] + y6[4] * x4[0]); ///< (drk / dfx) * (drk / dRy)
        Data[9] += a * x6[5] * x4[0] + c * y6[5] * y4[0] + b * (x6[5] * y4[0] + y6[5] * x4[0]); ///< (drk / dfx) * (drk / dRz)

        Data[10] += a * x4[1] * x4[1] + c * y4[1] * y4[1] + b * (x4[1] * y4[1] + y4[1] * x4[1]); ///< (drk / dfy) * (drk / dfy)
        Data[11] += a * x4[2] * x4[1] + c * y4[2] * y4[1] + b * (x4[2] * y4[1] + y4[2] * x4[1]); ///< (drk / dfy) * (drk / dcx)
        Data[12] += a * x4[3] * x4[1] + c * y4[3] * y4[1] + b * (x4[3] * y4[1] + y4[3] * x4[1]); ///< (drk / dfy) * (drk / dcy)
        Data[13] += a * x6[0] * x4[1] + c * y6[0] * y4[1] + b * (x6[0] * y4[1] + y6[0] * x4[1]); ///< (drk / dfy) * (drk / dtx)
        Data[14] += a * x6[1] * x4[1] + c * y6[1] * y4[1] + b * (x6[1] * y4[1] + y6[1] * x4[1]); ///< (drk / dfy) * (drk / dty)
        Data[15] += a * x6[2] * x4[1] + c * y6[2] * y4[1] + b * (x6[2] * y4[1] + y6[2] * x4[1]); ///< (drk / dfy) * (drk / dtz)
        Data[16] += a * x6[3] * x4[1] + c * y6[3] * y4[1] + b * (x6[3] * y4[1] + y6[3] * x4[1]); ///< (drk / dfy) * (drk / dRx)
        Data[17] += a * x6[4] * x4[1] + c * y6[4] * y4[1] + b * (x6[4] * y4[1] + y6[4] * x4[1]); ///< (drk / dfy) * (drk / dRy)
        Data[18] += a * x6[5] * x4[1] + c * y6[5] * y4[1] + b * (x6[5] * y4[1] + y6[5] * x4[1]); ///< (drk / dfy) * (drk / dRz)

        Data[19] += a * x4[2] * x4[2] + c * y4[2] * y4[2] + b * (x4[2] * y4[2] + y4[2] * x4[2]); ///< (drk / dcx) * (drk / dcx)
        Data[20] += a * x4[3] * x4[2] + c * y4[3] * y4[2] + b * (x4[3] * y4[2] + y4[3] * x4[2]); ///< (drk / dcx) * (drk / dcy)
        Data[21] += a * x6[0] * x4[2] + c * y6[0] * y4[2] + b * (x6[0] * y4[2] + y6[0] * x4[2]); ///< (drk / dcx) * (drk / dtx)
        Data[22] += a * x6[1] * x4[2] + c * y6[1] * y4[2] + b * (x6[1] * y4[2] + y6[1] * x4[2]); ///< (drk / dcx) * (drk / dty)
        Data[23] += a * x6[2] * x4[2] + c * y6[2] * y4[2] + b * (x6[2] * y4[2] + y6[2] * x4[2]); ///< (drk / dcx) * (drk / dtz)
        Data[24] += a * x6[3] * x4[2] + c * y6[3] * y4[2] + b * (x6[3] * y4[2] + y6[3] * x4[2]); ///< (drk / dcx) * (drk / dRx)
        Data[25] += a * x6[4] * x4[2] + c * y6[4] * y4[2] + b * (x6[4] * y4[2] + y6[4] * x4[2]); ///< (drk / dcx) * (drk / dRy)
        Data[26] += a * x6[5] * x4[2] + c * y6[5] * y4[2] + b * (x6[5] * y4[2] + y6[5] * x4[2]); ///< (drk / dcx) * (drk / dRz)

        Data[27] += a * x4[3] * x4[3] + c * y4[3] * y4[3] + b * (x4[3] * y4[3] + y4[3] * x4[3]); ///< (drk / dcy) * (drk / dcy)
        Data[28] += a * x6[0] * x4[3] + c * y6[0] * y4[3] + b * (x6[0] * y4[3] + y6[0] * x4[3]); ///< (drk / dcy) * (drk / dtx)
        Data[29] += a * x6[1] * x4[3] + c * y6[1] * y4[3] + b * (x6[1] * y4[3] + y6[1] * x4[3]); ///< (drk / dcy) * (drk / dty)
        Data[30] += a * x6[2] * x4[3] + c * y6[2] * y4[3] + b * (x6[2] * y4[3] + y6[2] * x4[3]); ///< (drk / dcy) * (drk / dtz)
        Data[31] += a * x6[3] * x4[3] + c * y6[3] * y4[3] + b * (x6[3] * y4[3] + y6[3] * x4[3]); ///< (drk / dcy) * (drk / dRx)
        Data[32] += a * x6[4] * x4[3] + c * y6[4] * y4[3] + b * (x6[4] * y4[3] + y6[4] * x4[3]); ///< (drk / dcy) * (drk / dRy)
        Data[33] += a * x6[5] * x4[3] + c * y6[5] * y4[3] + b * (x6[5] * y4[3] + y6[5] * x4[3]); ///< (drk / dcy) * (drk / dRz)

        Data[34] += a * x6[0] * x6[0] + c * y6[0] * y6[0] + b * (x6[0] * y6[0] + y6[0] * x6[0]); ///< (drk / dtx) * (drk / dtx)
        Data[35] += a * x6[1] * x6[0] + c * y6[1] * y6[0] + b * (x6[1] * y6[0] + y6[1] * x6[0]); ///< (drk / dtx) * (drk / dty)
        Data[36] += a * x6[2] * x6[0] + c * y6[2] * y6[0] + b * (x6[2] * y6[0] + y6[2] * x6[0]); ///< (drk / dtx) * (drk / dtz)
        Data[37] += a * x6[3] * x6[0] + c * y6[3] * y6[0] + b * (x6[3] * y6[0] + y6[3] * x6[0]); ///< (drk / dtx) * (drk / dRx)
        Data[38] += a * x6[4] * x6[0] + c * y6[4] * y6[0] + b * (x6[4] * y6[0] + y6[4] * x6[0]); ///< (drk / dtx) * (drk / dRy)
        Data[39] += a * x6[5] * x6[0] + c * y6[5] * y6[0] + b * (x6[5] * y6[0] + y6[5] * x6[0]); ///< (drk / dtx) * (drk / dRz)

        Data[40] += a * x6[1] * x6[1] + c * y6[1] * y6[1] + b * (x6[1] * y6[1] + y6[1] * x6[1]); ///< (drk / dty) * (drk / dty)
        Data[41] += a * x6[2] * x6[1] + c * y6[2] * y6[1] + b * (x6[2] * y6[1] + y6[2] * x6[1]); ///< (drk / dty) * (drk / dtz)
        Data[42] += a * x6[3] * x6[1] + c * y6[3] * y6[1] + b * (x6[3] * y6[1] + y6[3] * x6[1]); ///< (drk / dty) * (drk / dRx)
        Data[43] += a * x6[4] * x6[1] + c * y6[4] * y6[1] + b * (x6[4] * y6[1] + y6[4] * x6[1]); ///< (drk / dty) * (drk / dRy)
        Data[44] += a * x6[5] * x6[1] + c * y6[5] * y6[1] + b * (x6[5] * y6[1] + y6[5] * x6[1]); ///< (drk / dty) * (drk / dRz)

        Data[45] += a * x6[2] * x6[2] + c * y6[2] * y6[2] + b * (x6[2] * y6[2] + y6[2] * x6[2]); ///< (drk / dtz) * (drk / dtz)
        Data[46] += a * x6[3] * x6[2] + c * y6[3] * y6[2] + b * (x6[3] * y6[2] + y6[3] * x6[2]); ///< (drk / dtz) * (drk / dRx)
        Data[47] += a * x6[4] * x6[2] + c * y6[4] * y6[2] + b * (x6[4] * y6[2] + y6[4] * x6[2]); ///< (drk / dtz) * (drk / dRy)
        Data[48] += a * x6[5] * x6[2] + c * y6[5] * y6[2] + b * (x6[5] * y6[2] + y6[5] * x6[2]); ///< (drk / dtz) * (drk / dRz)

        Data[49] += a * x6[3] * x6[3] + c * y6[3] * y6[3] + b * (x6[3] * y6[3] + y6[3] * x6[3]); ///< (drk / dRx) * (drk / dRx)
        Data[50] += a * x6[4] * x6[3] + c * y6[4] * y6[3] + b * (x6[4] * y6[3] + y6[4] * x6[3]); ///< (drk / dRx) * (drk / dRy)
        Data[51] += a * x6[5] * x6[3] + c * y6[5] * y6[3] + b * (x6[5] * y6[3] + y6[5] * x6[3]); ///< (drk / dRx) * (drk / dRz)

        Data[52] += a * x6[4] * x6[4] + c * y6[4] * y6[4] + b * (x6[4] * y6[4] + y6[4] * x6[4]); ///< (drk / dRy) * (drk / dRy)
        Data[53] += a * x6[5] * x6[4] + c * y6[5] * y6[4] + b * (x6[5] * y6[4] + y6[5] * x6[4]); ///< (drk / dRy) * (drk / dRz)

        Data[54] += a * x6[5] * x6[5] + c * y6[5] * y6[5] + b * (x6[5] * y6[5] + y6[5] * x6[5]); ///< (drk / dRz) * (drk / dRz)
    ...
    /**
     * @brief 计算 target --> host 之间的H[(Tth,C)和(ath,bth)] 和 b[(Tth,C)和(ath,bth)]
     *de
     * @param x4	 	输入的 dpjf[x] / dC
     * @param x6		输入的 dpjf[x] / dC
     * @param y4		输入的 dpjf[y] / dTthf
     * @param y6		输入的 dpjf[y] / dTthf
     * @param TR00		输入的 sum((drk / dathf) * (drk / dpjf[x]))
     * @param TR10		输入的 sum((drk / dathf) * (drk / dpjf[y]))
     * @param TR01		输入的 sum((drk / dbthf) * (drk / dpjf[x]))
     * @param TR11		输入的 sum((drk / dbthf) * (drk / dpjf[y]))
     * @param TR02		输入的 sum(rk * drk / dpjf[x])
     * @param TR12		输入的 sum(rk * drk / dpjf[y])
     */
    inline void updateTopRight(const float *const x4, const float *const x6, const float *const y4, const float *const y6, const float TR00, const float TR10,
        ...
        TopRight_Data[0] += x4[0] * TR00 + y4[0] * TR10; ///< (drk / dfx) * (drk / dathf)
        TopRight_Data[1] += x4[0] * TR01 + y4[0] * TR11; ///< (drk / dfx) * (drk / dbthf)
        TopRight_Data[2] += x4[0] * TR02 + y4[0] * TR12; ///< (drk / dfx) * rk

        TopRight_Data[3] += x4[1] * TR00 + y4[1] * TR10; ///< (drk / dfy) * (drk / dathf)
        TopRight_Data[4] += x4[1] * TR01 + y4[1] * TR11; ///< (drk / dfy) * (drk / dbthf)
        TopRight_Data[5] += x4[1] * TR02 + y4[1] * TR12; ///< (drk / dfy) * rk

        TopRight_Data[6] += x4[2] * TR00 + y4[2] * TR10; ///< (drk / dcx) * (drk / dathf)
        TopRight_Data[7] += x4[2] * TR01 + y4[2] * TR11; ///< (drk / dcx) * (drk / dbthf)
        TopRight_Data[8] += x4[2] * TR02 + y4[2] * TR12; ///< (drk / dcx) * rk

        TopRight_Data[9] += x4[3] * TR00 + y4[3] * TR10;  ///< (drk / dcy) * (drk / dathf)
        TopRight_Data[10] += x4[3] * TR01 + y4[3] * TR11; ///< (drk / dcy) * (drk / dbthf)
        TopRight_Data[11] += x4[3] * TR02 + y4[3] * TR12; ///< (drk / dcy) * rk

        TopRight_Data[12] += x6[0] * TR00 + y6[0] * TR10; ///< (drk / dtx) * (drk / dathf)
        TopRight_Data[13] += x6[0] * TR01 + y6[0] * TR11; ///< (drk / dtx) * (drk / dbthf)
        TopRight_Data[14] += x6[0] * TR02 + y6[0] * TR12; ///< (drk / dtx) * rk

        TopRight_Data[15] += x6[1] * TR00 + y6[1] * TR10; ///< (drk / dty) * (drk / dathf)
        TopRight_Data[16] += x6[1] * TR01 + y6[1] * TR11; ///< (drk / dty) * (drk / dbthf)
        TopRight_Data[17] += x6[1] * TR02 + y6[1] * TR12; ///< (drk / dty) * rk

        TopRight_Data[18] += x6[2] * TR00 + y6[2] * TR10; ///< (drk / dtz) * (drk / dathf)
        TopRight_Data[19] += x6[2] * TR01 + y6[2] * TR11; ///< (drk / dtz) * (drk / dbthf)
        TopRight_Data[20] += x6[2] * TR02 + y6[2] * TR12; ///< (drk / dtz) * rk

        TopRight_Data[21] += x6[3] * TR00 + y6[3] * TR10; ///< (drk / dRx) * (drk / dathf)
        TopRight_Data[22] += x6[3] * TR01 + y6[3] * TR11; ///< (drk / dRx) * (drk / dbthf)
        TopRight_Data[23] += x6[3] * TR02 + y6[3] * TR12; ///< (drk / dRx) * rk

        TopRight_Data[24] += x6[4] * TR00 + y6[4] * TR10; ///< (drk / dRy) * (drk / dathf)
        TopRight_Data[25] += x6[4] * TR01 + y6[4] * TR11; ///< (drk / dRy) * (drk / dbthf)
        TopRight_Data[26] += x6[4] * TR02 + y6[4] * TR12; ///< (drk / dRy) * rk

        TopRight_Data[27] += x6[5] * TR00 + y6[5] * TR10; ///< (drk / dRz) * (drk / dathf)
        TopRight_Data[28] += x6[5] * TR01 + y6[5] * TR11; ///< (drk / dRz) * (drk / dbthf)
        TopRight_Data[29] += x6[5] * TR02 + y6[5] * TR12; ///< (drk / dRz) * rk
    }

    /**
     * @brief 更新和ath 和 bth有关的Hessian和b部分
     *
     * @param a00	输入的 sum(drk / dath) * (drk / dath)
     * @param a01	输入的 sum(drk / dath) * (drk / dbth)
     * @param a02	输入的 sum(rk * drk / dath)
     * @param a11	输入的 sum(drk / dbth) * (drk / dbth)
     * @param a12	输入的 sum(rk * drk / dbth)
     * @param a22	输入的 sum(rk * rk)
     */
    inline void updateBotRight(const float a00, const float a01, const float a02, const float a11, const float a12, const float a22) {
        BotRight_Data[0] += a00; ///< sum(drk / dath) * (drk / dath)
        BotRight_Data[1] += a01; ///< sum(drk / dath) * (drk / dbth)
        BotRight_Data[2] += a02; ///< sum(rk * drk / dath)
        BotRight_Data[3] += a11; ///< sum(drk / dbth) * (drk / dbth)
        BotRight_Data[4] += a12; ///< sum(rk * drk / dbth)
        BotRight_Data[5] += a22; ///< sum(rk * rk)
    }
